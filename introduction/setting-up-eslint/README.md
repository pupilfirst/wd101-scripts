...
In this lesson, we will learn to set up ESLint extension for Visual Studio Code.
...
ESLint analyses your code to quickly find problems. It is the standard tool for identifying and reporting on coding patterns found in JavaScript code. The goal of ESLint is to make code more consistent while avoiding bugs. `ESLint` is intelligent enough to suggest fixes to most problems it finds out.
...
It can provide project-wide issue list on the issues tab of your Visual Studio Code, which you can fix one at a time.
